# Contributing to alexyusomo

Thanks for your interest in contributing! alexyusomo is a fork of
...
- Include: Node.js version, `@alexyusomo/baileys` version, a minimal reproduction,
...
```bash
git clone https://github.com/alexyusomo/baileys.git
cd baileys
npm install
npm run build:tsc
npm test
