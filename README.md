...
[![GitHub](https://img.shields.io/badge/source-GitHub-black.svg)](https://github.com/alexyusomo/Baileys)
[![Node](https://img.shields.io/badge/node-%3E%3D20-brightgreen.svg)](package.json)

A WebSockets library for interacting with WhatsApp Web, maintained under the **alexyusomo** brand.
...
```bash
npm install github:alexyusomo/Baileys
```

Or add it to your `package.json` manually:
```json
"dependencies": {
  "@alexyusomo/baileys": "github:alexyusomo/Baileys"
}
```
...
```json
"dependencies": {
  "@whiskeysockets/baileys": "github:alexyusomo/Baileys"
}
```
...
```bash
npm install github:alexyusomo/Baileys#main
```
...
const client = makeWASocket({
  browser: Browsers.alexyusomo('Chrome'),
...
await client.relayMessage(m.chat, {
  conversation: "Hello from alexyusomo"
}, {
  noSelfSync: true
});
...
alexyusomo is a fork of [Baileys](https://github.com/WhiskeySockets/Baileys), originally created by
